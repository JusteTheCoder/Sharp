...
--[=[
	return a t.union of each key in the table as a t.literal

	@param keyTable {any: any} -- The table to get keys from
...
--[=[
	return a t.union of each value in the table as a t.literal

	@param valueTable {any: any} -- The table to get values from
...
--[=[
	...
	@param min number -- The minimum to use
...
--[=[
	...
	@param max number -- The maximum to use
...
--[=[
	...
	@param check (any) -> (boolean) -- The check to use
...
--[=[
	...
	@param ... any -- The type definition for the tuples
...
--[=[
	...
	@param check (any) -> (boolean) -- The function to use to check the keys
...
--[=[
	...
	@param check (any) -> (boolean) -- The function to use to check the values
...
--[=[
	...
	@param keyCheck (any) -> (boolean) -- The function to use to check the keys
	@param valueCheck (any) -> (boolean) -- The function to use to check the values
...
do
	...
	--[=[
		...
		@param check (any) -> (boolean) -- The check to compare all values with
	...
	--[=[
		...
		@param ... (any) -> (boolean) -- The check to compare all values with
...
do
	...
	--[=[
		...
		@param ... any -- The checks to intersect
...
do
	...
	--[=[
		...
		@param checkTable {any: any} -- The interface definition
...
--[=[
	...
	@param enum Enum -- The enum to check
...
do
	...
	--[=[
		...
		@param checkArgs any -- The function to use to check arguments in the assert
...
--[=[
	...
	@param check (...: any) -> boolean? -- The function to wrap with an assert
...
do
	...
	--[=[
		...
		If you pass in a tree with more than one child of the same name, this function will always return false

		:::

		@param checkTable any -- The table to check against
